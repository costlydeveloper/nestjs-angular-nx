  ...
  /******/ var __webpack_modules__ = [
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      exports['default'] = (0, config_1.registerAs)('database', () => ({
        ...
        port:
          parseInt(process.env['DB_PORT'], 10) || ports_config_1.POSTGRES_PORT,
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      let LocalConfigModule =
        (exports.LocalConfigModule = class LocalConfigModule {});
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata(
            'design:type',
            typeof (_a =
              typeof utils_1.Nullable !== 'undefined' && utils_1.Nullable) ===
              'function'
              ? _a
              : Object,
          ),
      ...
      tslib_1.__decorate(
        [
          (0, typeorm_1.Column)({
            ...
            default: task_status_enum_1.TaskStatus.OPEN,
          }),
          tslib_1.__metadata(
            'design:type',
            typeof (_d =
              typeof task_status_enum_1.TaskStatus !== 'undefined' &&
              task_status_enum_1.TaskStatus) === 'function'
              ? _d
              : Object,
          ),
        ],
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata(
            'design:type',
            typeof (_e =
              typeof users_1.User !== 'undefined' && users_1.User) ===
              'function'
              ? _e
              : Object,
          ),
      ...
      exports.Task = Task = tslib_1.__decorate([(0, typeorm_1.Entity)()], Task);
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const tslib_1 = __webpack_require__(2);
      const common_1 = __webpack_require__(9);
      let SharedCommonModule =
        (exports.SharedCommonModule = class SharedCommonModule {});
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      let DbErrorHandlerModule =
        (exports.DbErrorHandlerModule = class DbErrorHandlerModule {});
      exports.DbErrorHandlerModule = DbErrorHandlerModule = tslib_1.__decorate(
        [
          (0, common_1.Module)({
            providers: [
              db_error_handler_service_1.DbErrorHandler,
              db_error_provider_1.DatabaseErrorsProvider,
            ],
      ...
      exports.DbErrorHandler = DbErrorHandler = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof type_interface_1.IDbError !== 'undefined' &&
              type_interface_1.IDbError) === 'function'
              ? _a
              : Object,
          ]),
        ],
      ...
      exports.DatabaseErrorsProvider = {
        ...
        useFactory: () => {
          ...
          switch (platform_1.environmentGlobal.database.type) {
            ...
            default:
              throw new Error(
                messages_1.MESSAGE.ERROR.UNSUPPORTED_DATABASE_TYPE,
              );
          }
          return errorType;
        },
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      let SharedUtilsModule =
        (exports.SharedUtilsModule = class SharedUtilsModule {});
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      function Serialize(dto) {
        return (0, common_1.UseInterceptors)(
          new serialize_interceptor_1.SerializeInterceptor(dto),
        );
      }
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      let TransformInterceptor =
        (exports.TransformInterceptor = class TransformInterceptor {
          intercept(context, next) {
            return next.handle().pipe(
              (0, operators_1.map)((data) =>
                (0, class_transformer_1.plainToClass)(data, {
                  excludeExtraneousValues: true,
                }),
              ),
            );
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      exports.UsersModule = UsersModule = tslib_1.__decorate(
        [
          (0, common_2.Module)({
            imports: [
              common_1.DbErrorHandlerModule,
              typeorm_1.TypeOrmModule.forFeature([user_entity_1.User]),
            ],
            providers: [
              users_service_1.UsersService,
              users_repository_service_1.UsersRepository,
            ],
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      exports.User = User = tslib_1.__decorate([(0, typeorm_1.Entity)()], User);
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const user_entity_1 = __webpack_require__(67);
      let UsersRepository =
        (exports.UsersRepository = class UsersRepository extends (
          common_1.BaseRepository
        ) {
          constructor(repo) {
            super(repo);
          }
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const users_service_1 = __webpack_require__(72);
      let UsersController =
        (exports.UsersController = class UsersController extends (
          common_1.BaseController
        ) {
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_b =
              typeof auth_credentials_dto_1.AuthCredentialsDto !==
                'undefined' && auth_credentials_dto_1.AuthCredentialsDto) ===
            'function'
              ? _b
              : Object,
          ]),
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const user_entity_1 = __webpack_require__(67);
      const users_repository_service_1 = __webpack_require__(68);
      let UsersService = (exports.UsersService = class UsersService extends (
        common_1.BaseEntityService
      ) {
        ...
        async create(createUserDto) {
          ...
          newUser.password = (0, utils_1.encodePassword)(
            createUserDto.password,
          );
          try {
            const storedUser = await this.usersRepository.save(newUser);
            const { password } = storedUser,
              userWithoutPassword = tslib_1.__rest(storedUser, ['password']);
            return userWithoutPassword;
          } catch (error) {
            if (error.code === this.dbErrHandler.codes.UNIQUE_VIOLATION) {
              throw new common_2.ConflictException(
                common_1.MESSAGE.ERROR.USERNAME_EXIST,
              );
            } else {
      ...
      exports.UsersService = UsersService = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof users_repository_service_1.UsersRepository !==
                'undefined' && users_repository_service_1.UsersRepository) ===
            'function'
              ? _a
              : Object,
            typeof (_b =
              typeof common_1.DbErrorHandler !== 'undefined' &&
              common_1.DbErrorHandler) === 'function'
              ? _b
              : Object,
          ]),
        ],
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const users_1 = __webpack_require__(60);
      let EndpointsModule =
        (exports.EndpointsModule = class EndpointsModule {});
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_e =
              typeof users_1.IUserIdentifier !== 'undefined' &&
              users_1.IUserIdentifier) === 'function'
              ? _e
              : Object,
          ]),
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      exports.AuthService = AuthService = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof users_1.UsersService !== 'undefined' &&
              users_1.UsersService) === 'function'
              ? _a
              : Object,
            typeof (_b =
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const passport_1 = __webpack_require__(78);
      let LocalAuthGuard =
        (exports.LocalAuthGuard = class LocalAuthGuard extends (
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const core_1 = __webpack_require__(76);
      const passport_1 = __webpack_require__(78);
      let JwtAuthGuard = (exports.JwtAuthGuard = class JwtAuthGuard extends (
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      let JwtStrategy = (exports.JwtStrategy = class JwtStrategy extends (
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const users_1 = __webpack_require__(60);
      let LocalStrategy = (exports.LocalStrategy = class LocalStrategy extends (
        ...
        async validateUser(username, password) {
          ...
          if (
            storedUser &&
            (0, utils_1.comparePasswords)(password, storedUser.password)
          ) {
            const { password } = storedUser,
              userWithoutPassword = tslib_1.__rest(storedUser, ['password']);
            return userWithoutPassword;
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const tasks_service_1 = __webpack_require__(92);
      let TasksController =
        (exports.TasksController = class TasksController extends (
          common_1.BaseController
        ) {
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_b =
              typeof get_tasks_filter_dto_1.GetTasksFilterDto !== 'undefined' &&
              get_tasks_filter_dto_1.GetTasksFilterDto) === 'function'
              ? _b
              : Object,
            typeof (_c =
              typeof users_1.User !== 'undefined' && users_1.User) ===
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_e =
              typeof create_task_dto_1.CreateTaskDto !== 'undefined' &&
              create_task_dto_1.CreateTaskDto) === 'function'
              ? _e
              : Object,
            typeof (_f =
              typeof users_1.User !== 'undefined' && users_1.User) ===
      ...
      tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            String,
            typeof (_h =
              typeof update_task_status_dto_1.UpdateTaskStatusDto !==
                'undefined' && update_task_status_dto_1.UpdateTaskStatusDto) ===
            'function'
              ? _h
              : Object,
            typeof (_j =
      ...
      exports.TasksController = TasksController = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof tasks_service_1.TasksService !== 'undefined' &&
              tasks_service_1.TasksService) === 'function'
              ? _a
              : Object,
          ]),
        ],
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const common_2 = __webpack_require__(9);
      const tasks_repository_1 = __webpack_require__(93);
      let TasksService = (exports.TasksService = class TasksService extends (
        common_1.BaseEntityService
      ) {
      ...
      exports.TasksService = TasksService = tslib_1.__decorate(
        [
          ...
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof tasks_repository_1.TasksRepository !== 'undefined' &&
              tasks_repository_1.TasksRepository) === 'function'
              ? _a
              : Object,
          ]),
        ],
    ...
    /***/ (__unused_webpack_module, exports, __webpack_require__) => {
      ...
      const task_entity_1 = __webpack_require__(15);
      let TasksRepository =
        (exports.TasksRepository = class TasksRepository extends (
          common_1.BaseRepository
        ) {
          constructor(repo) {
            super(repo);
      ...
      exports.TasksRepository = TasksRepository = tslib_1.__decorate(
        [
          ...
          tslib_1.__param(
            0,
            (0, typeorm_1.InjectRepository)(task_entity_1.Task),
          ),
          tslib_1.__metadata('design:paramtypes', [
            typeof (_a =
              typeof typeorm_2.Repository !== 'undefined' &&
